...
$buttcoin"#;
    ...
    #[test]
    fn test_retweet_shawmakesmagic() {
...
lesson in there"#;
    ...
    #[test]
    fn test_tweet_onlyljc() {
        let message = r#"📝 OnlyLJC Tweeted
Why everytime a fat girl serves my coffee she is rude and soulless, but the baddie smiles and makes your day better 
Like piggy if you want a tip for more cookies atleast be nice"#;
    ...
    #[test]
    fn test_tweet_recession_warning() {
...
Brace for impact."#;
        ...
        match result {
            MessageType::Unknown => {
                // This is expected - no emoji prefix, so won't match
            }
    ...
    #[test]
    fn test_tweet_cryptolyxe_advice() {
...
Lol"#;
        ...
        match result {
            MessageType::Quote { user, text, quoted } => {
                assert_eq!(user, "shawmakesmagic");
    ...
    #[test]
    fn test_tweet_cryptolyxe_morning() {
        let message = r#"📝 cryptolyxe Tweeted
...
🔗 http://github.com/rohunvora"#;
        ...
        let result = follow_regex().captures(message);
        assert!(result.is_some());
        let caps = result.unwrap();

        assert_eq!(&caps[1], "blknoiz06");
        assert_eq!(&caps[2], "rohunvora");
    }

    #[test]
    fn test_follow_shawmakesmagic() {
...
🔗 http://warpcast.com/seanwbren"#;
        ...
        assert_eq!(&caps[1], "shawmakesmagic");
        assert_eq!(&caps[2], "seanwbren");
    }
...
🔗 https://partner.blofin.com/d/Inuyasha"#;
        ...
        assert_eq!(&caps[1], "toly");
        assert_eq!(&caps[2], "yashaxbt");
    }

    #[test]
    fn test_follow_pmarca() {
...
🔗 https://x.com/cia/status/486255845588475905"#;
        ...
        assert_eq!(&caps[1], "pmarca");
        assert_eq!(&caps[2], "chiweethedog");
    }
